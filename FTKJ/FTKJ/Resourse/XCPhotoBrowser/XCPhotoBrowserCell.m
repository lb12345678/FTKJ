...
//    [_imgView sd_cancelCurrentAnimationImagesLoad];
    ...
    [_imgView sd_setImageWithURL:[NSURL URLWithString:self.model.url] placeholderImage:_model.image completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
        if (!self) return;
