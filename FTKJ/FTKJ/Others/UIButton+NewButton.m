                        ...
                        imageTitleSpace:(CGFloat)space weight:(CGFloat)weight
{
    ...
    switch (style) {
        case MKButtonEdgeInsetsStyleTop:
        {
            ...
            labelEdgeInsets = UIEdgeInsetsMake(0, -imageWith, -imageHeight-6/2, 0);
           ...
           imageEdgeInsets = UIEdgeInsetsMake(-labelHeight-6/2, 0, 0, -labelWidth);
            
            
//           imageEdgeInsets = UIEdgeInsetsMake(-labelHeight-space/2.0, 0, 0, -labelWidth );
//           
//            labelEdgeInsets = UIEdgeInsetsMake(0, -0, -imageHeight-space/2.0, -labelWidth);
        }
            break;
        case MKButtonEdgeInsetsStyleLeft:
        {
            imageEdgeInsets = UIEdgeInsetsMake(0, -space/2.0, 0, space/2.0);
            labelEdgeInsets = UIEdgeInsetsMake(0, space/2.0, weight, -space/2.0);
        }
            break;
