...
- (void)initView{
    ...
    //  设定button大小为适应图片
    UIImage *normalImage = [UIImage imageNamed:@"发布"];
    ...
    _centerBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - normalImage.size.width)/2.0, kWidthChange(7), normalImage.size.width, normalImage.size.height);
